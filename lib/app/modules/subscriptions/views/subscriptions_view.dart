        ...
        children: [
          Row(
            children: [
              ...
              spaceW(width: 8),
              const Text("Active Plan", style: TextStyle(fontSize: 14, fontFamily: FontFamily.bold, color: Colors.white)),
              const Spacer(),
              Container(
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text("Ads Posted", style: TextStyle(fontSize: 11, color: Colors.white.withValues(alpha: 0.8))),
                    spaceH(height: 2),
                    Text(
              ...
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text("Days Remaining", style: TextStyle(fontSize: 11, color: Colors.white.withValues(alpha: 0.8))),
                    spaceH(height: 2),
                    Text(
        ...
        child: Center(
          child: Column(
            children: [
              ...
              spaceH(height: 12),
              TextCustom(title: "No packages available", fontSize: 14, color: isDark ? AppThemeData.grey5 : AppThemeData.grey6),
            ],
          ),
        ),
      );
            ...
            child: SizedBox(
              ...
              child: isActive
                  ? Container(
                      ...
                      child: const Center(child: Text("Current Plan", style: TextStyle(fontSize: 15, fontFamily: FontFamily.semiBold, color: Color(0xff4CAF50)))),
                    )
                  : ElevatedButton(
                      ...
                      child: const Text("Buy Now", style: TextStyle(fontSize: 15, fontFamily: FontFamily.semiBold, color: Colors.white)),
                    ),
            ),
          ),
        ],
